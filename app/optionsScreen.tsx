      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingTextContainer}>
              <Text style={styles.settingTitle}>Profile info</Text>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <View style={styles.settingTextContainer}>
              ...
              <Text style={styles.settingSubtitle}>maybe password and security settings</Text>
            </View>
            <Ionicons name="chevron-forward" size={18} color="#9CA3AF" />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingItem}>
            ...
            <View style={styles.settingTextContainer}>
              <Text style={styles.settingTitle}>Notif</Text>
...
ios_backgroundColor={darkMode ? '#374151' : '#E5E7EB'}
          ...
          <View style={styles.settingItem}>
            ...
            <View style={styles.settingTextContainer}>
              <Text style={styles.settingTitle}>Not so dark Mode</Text>
              <Text style={styles.settingSubtitle}>DONT GO BLIND</Text>
            </View>
            <Switch
